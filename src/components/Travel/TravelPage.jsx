        ...
        <div className="ps-48">
          <div className="flex-col me-10 w-prose">
            ...
            <p className="text-lg text-gray-600 font-semibold">
              Discover exciting and latest world events, travel deals, safety
              tips and more news.
            </p>
          </div>
        </div>
        ...
        <div className="flex-col">
          ...
          <div className="flex w-36 justify-between py-2">
            <img
              ...
              alt="circled-left-2"
            />
            <div className="text-5 bg-slate-200 w-7 h-7 text-center font-semibold cursor-pointer">
              01
            </div>
          ...
          {/* images */}
          <div className="flex overflow-x-scroll basis-1/2">
            <img
              className="max-w-72 me-3"
            ...
            <img
              className="max-w-72 me-3"
              src="https://images.unsplash.com/photo-1708514349420-4eeb8397e733?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw4fHx8ZW58MHx8fHx8"
              alt=""
            />
            <img
              className="max-w-72 me-3"
              src="https://plus.unsplash.com/premium_photo-1708769592969-9f42825496a7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMnx8fGVufDB8fHx8fA%3D%3D"
              alt=""
            />
          </div>
        </div>
